...
upjsonnet() {
	jsonnet -y jsonnet/db.jsonnet -V r_name=r4 -V r_ns=app3 -V r_chart=demo | kubectl apply -f -
	jsonnet -y jsonnet/frontend.jsonnet -V r_name=r4 -V r_ns=app3 -V r_chart=demo | kubectl apply -f -
	jsonnet -y jsonnet/ext.jsonnet -V r_name=r4 -V r_ns=app3 -V r_chart=demo | kubectl apply -f -
	jsonnet -y jsonnet/backend.jsonnet -V r_name=r4 -V r_ns=app3 -V r_chart=demo | kubectl apply -f -
}

downjsonnet() {
	jsonnet -y jsonnet/ext.jsonnet -V r_name=r4 -V r_ns=app3 -V r_chart=demo | kubectl delete -f -
	jsonnet -y jsonnet/frontend.jsonnet -V r_name=r4 -V r_ns=app3 -V r_chart=demo | kubectl delete -f -
	jsonnet -y jsonnet/backend.jsonnet -V r_name=r4 -V r_ns=app3 -V r_chart=demo | kubectl delete -f -
	jsonnet -y jsonnet/db.jsonnet -V r_name=r4 -V r_ns=app3 -V r_chart=demo | kubectl delete -f -
}

testjsonnet() {
	jsonnet -y jsonnet/test_frontend.jsonnet -V r_name=r4 -V r_ns=app3 -V r_chart=demo | kubectl apply -f -
	jsonnet -y jsonnet/test_backend.jsonnet -V r_name=r4 -V r_ns=app3 -V r_chart=demo | kubectl apply -f -
}
...
if [ $1 ]; then
	...
	echo "  upjsonnet - deploy app from jsonnet"
	echo "  testjsonnet - create test pods for jsonnet app"
	echo "  downjsonnet - remove app deployed from jsonnet"
