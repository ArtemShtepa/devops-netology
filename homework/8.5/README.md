...
> 1. Выполните `docker pull aragast/netology:latest` -  это образ с podman, tox и несколькими пайтонами (3.7 и 3.9) внутри
>
> Для того, чтобы **molecule** могла работать с **docker** нужно установить соответствующий драйвер: `pip3 install "molecule_docker==1.1.0"`
>
...
```console
sa@debian:~/my-ansible-5/ansible-clickhouse$ molecule --version
molecule 3.5.2 using python 3.10
    ansible:2.13.2
    delegated:3.5.2 from molecule
    docker:1.1.0 from molecule_docker requiring collections: community.docker>=1.9.1
sa@debian:~/my-ansible-5/ansible-clickhouse$
```
...
<details>
<summary>:exclamation: Разбор вывода теста <b>molecule</b>... Лог очень длинный :bangbang:</summary>

```console
sa@debian:~/my-ansible-5/ansible-clickhouse$ molecule test -s centos_7
INFO     centos_7 scenario test matrix: dependency, lint, cleanup, destroy, syntax, create, prepare, converge, idempotence, side_effect, verify, cleanup, destroy
INFO     Performing prerun...
INFO     Set ANSIBLE_LIBRARY=/home/sa/.cache/ansible-compat/b9a93c/modules:/home/sa/.ansible/plugins/modules:/usr/share/ansible/plugins/modules
INFO     Set ANSIBLE_COLLECTIONS_PATH=/home/sa/.cache/ansible-compat/b9a93c/collections:/home/sa/.ansible/collections:/usr/share/ansible/collections
INFO     Set ANSIBLE_ROLES_PATH=/home/sa/.cache/ansible-compat/b9a93c/roles:/home/sa/.ansible/roles:/usr/share/ansible/roles:/etc/ansible/roles
INFO     Inventory /home/sa/my-ansible-5/ansible-clickhouse/molecule/centos_7/../resources/inventory/hosts.yml linked to /home/sa/.cache/molecule/ansible-clickhouse/centos_7/inventory/hosts
INFO     Inventory /home/sa/my-ansible-5/ansible-clickhouse/molecule/centos_7/../resources/inventory/group_vars/ linked to /home/sa/.cache/molecule/ansible-clickhouse/centos_7/inventory/group_vars
INFO     Inventory /home/sa/my-ansible-5/ansible-clickhouse/molecule/centos_7/../resources/inventory/host_vars/ linked to /home/sa/.cache/molecule/ansible-clickhouse/centos_7/inventory/host_vars
...
INFO     Inventory /home/sa/my-ansible-5/ansible-clickhouse/molecule/centos_7/../resources/inventory/hosts.yml linked to
 /home/sa/.cache/molecule/ansible-clickhouse/centos_7/inventory/hosts
INFO     Inventory /home/sa/my-ansible-5/ansible-clickhouse/molecule/centos_7/../resources/inventory/group_vars/ linked to /home/sa/.cache/molecule/ansible-clickhouse/centos_7/inventory/group_vars
INFO     Inventory /home/sa/my-ansible-5/ansible-clickhouse/molecule/centos_7/../resources/inventory/host_vars/ linked to /home/sa/.cache/molecule/ansible-clickhouse/centos_7/inventory/host_vars
...
playbook: /home/sa/my-ansible-5/ansible-clickhouse/molecule/resources/playbooks/converge.yml
INFO     Inventory /home/sa/my-ansible-5/ansible-clickhouse/molecule/centos_7/../resources/inventory/hosts.yml linked to
 /home/sa/.cache/molecule/ansible-clickhouse/centos_7/inventory/hosts
INFO     Inventory /home/sa/my-ansible-5/ansible-clickhouse/molecule/centos_7/../resources/inventory/group_vars/ linked to /home/sa/.cache/molecule/ansible-clickhouse/centos_7/inventory/group_vars
INFO     Inventory /home/sa/my-ansible-5/ansible-clickhouse/molecule/centos_7/../resources/inventory/host_vars/ linked to /home/sa/.cache/molecule/ansible-clickhouse/centos_7/inventory/host_vars
...
ok: [localhost] => (item={'diff': [], 'dest': '/home/sa/.cache/molecule/ansible-clickhouse/centos_7/Dockerfile_centos_7', 'src': '/home/sa/.ansible/tmp/ansible-tmp-1659784396.3046184-3873-95148761793267/source', 'md5sum': 'e90d08cd34f49a5f8a41a07de1348618', 'checksum': '4b70768619482424811f2977aa277a5acf2b13a1', 'changed': True, 'uid': 1000, 'gid': 1000, 'owner': 'sa', 'group': 'sa', 'mode': '0600', 'state': 'file', 'size': 2199, 'invocation': {'module_args': {'src': '/home/sa/.ansible/tmp/ansible-tmp-1659784396.3046184-3873-95148761793267/source', 'dest': '/home/sa/.cache/molecule/ansible-clickhouse/centos_7/Dockerfile_centos_7', 'mode': '0600', 'follow': False, '_original_basename': 'Dockerfile.j2', 'checksum': '4b70768619482424811f2977aa277a5acf2b13a1', 'backup': False, 'force': True, 'unsafe_writes': False, 'content': None, 'validate': None, 'directory_mode': None, 'remote_src': None, 'local_follow': None, 'owner': None, 'group': None, 'seuser': None, 'serole': None, 'selevel': None, 'setype': None, 'attributes': None}}, 'failed': False, 'item': {'capabilities': ['SYS_ADMIN'], 'command': '/usr/sbin/init', 'dockerfile': '../resources/Dockerfile.j2', 'env': {'ANSIBLE_USER': 'ansible', 'DEPLOY_GROUP': 'deployer', 'SUDO_GROUP': 'wheel', 'container': 'docker'}, 'image': 'centos:7', 'name': 'centos_7', 'privileged': True, 'tmpfs': ['/run', '/tmp'], 'volumes': ['/sys/fs/cgroup:/sys/fs/cgroup']}, 'ansible_loop_var': 'item', 'i': 0, 'ansible_index_var': 'i'})
...
changed: [localhost] => (item={'failed': 0, 'started': 1, 'finished': 0, 'ansible_job_id': '478592296224.4738', 'results_file': '/home/sa/.ansible_async/478592296224.4738', 'changed': True, 'item': {'capabilities': ['SYS_ADMIN'], 'command': '/usr/sbin/init', 'dockerfile': '../resources/Dockerfile.j2', 'env': {'ANSIBLE_USER': 'ansible', 'DEPLOY_GROUP': 'deployer', 'SUDO_GROUP': 'wheel', 'container': 'docker'}, 'image': 'centos:7', 'name': 'centos_7', 'privileged': True, 'tmpfs': ['/run', '/tmp'], 'volumes': ['/sys/fs/cgroup:/sys/fs/cgroup']}, 'ansible_loop_var': 'item'})
...
included: /home/sa/my-ansible-5/ansible-clickhouse/tasks/precheck.yml for centos_7
...
TASK [ansible-clickhouse : include_tasks] **************************************
included: /home/sa/my-ansible-5/ansible-clickhouse/tasks/params.yml for centos_7
...
TASK [ansible-clickhouse : include_tasks] **************************************
included: /home/sa/my-ansible-5/ansible-clickhouse/tasks/install/yum.yml for centos_7
...
TASK [ansible-clickhouse : include_tasks] **************************************
included: /home/sa/my-ansible-5/ansible-clickhouse/tasks/configure/sys.yml for centos_7
...
--- before
+++ after: /home/sa/.ansible/tmp/ansible-local-4875ocmz5_ty/tmpdefjsh_1/config.j2
@@ -0,0 +1,382 @@
+<?xml version="1.0"?>
+<!--
+ -
...
--- before
+++ after: /home/sa/.ansible/tmp/ansible-local-4875ocmz5_ty/tmp0w4na9zy/users.j2
@@ -0,0 +1,106 @@
+<?xml version="1.0"?>
+<!--
+ -
...
TASK [ansible-clickhouse : include_tasks] **************************************
included: /home/sa/my-ansible-5/ansible-clickhouse/tasks/service.yml for centos_7
...
CRITICAL Ansible return code was 2, command was: ['ansible-playbook', '-D', '--inventory', '/home/sa/.cache/molecule/ansible-clickhouse/centos_7/inventory', '--skip-tags', 'molecule-notest,notest', '/home/sa/my-ansible-5/ansible-clickhouse/molecule/resources/playbooks/converge.yml']
...
В ходе теста было обнаружено более 50 нарушений правил YAML и более 50 нарушений Ansible.
Однако, соблюдение всех строгих правил YAML может привести к нечитаемости файла в Ansible даже последней версии (например, задание значений списков или массивов).
...
В конечном счёте, **playbook** "провалился" на шаге проверки старта `clickhouse-server.service` - скорее всего по причине работы в **Docker** контейнере, где наблюдаются проблемы с функционированием **SystemD**.
...
```console
sa@ubuntu22:~/ansible-clickhouse$ molecule test -s centos_7
INFO     centos_7 scenario test matrix: dependency, lint, cleanup, destroy, syntax, create, prepare, converge, idempotence, side_effect, verify, cleanup, destroy
INFO     Performing prerun with role_name_check=0...
INFO     Set ANSIBLE_LIBRARY=/home/sa/.cache/ansible-compat/b9a93c/modules:/home/sa/.ansible/plugins/modules:/usr/share/ansible/plugins/modules
INFO     Set ANSIBLE_COLLECTIONS_PATH=/home/sa/.cache/ansible-compat/b9a93c/collections:/home/sa/.ansible/collections:/usr/share/ansible/collections
INFO     Set ANSIBLE_ROLES_PATH=/home/sa/.cache/ansible-compat/b9a93c/roles:/home/sa/.ansible/roles:/usr/share/ansible/roles:/etc/ansible/roles
INFO     Using /home/sa/.cache/ansible-compat/b9a93c/roles/alexeysetevoi.clickhouse symlink to current repository in order to enable Ansible to find the role using its expected full name.
INFO     Inventory /home/sa/ansible-clickhouse/molecule/centos_7/../resources/inventory/hosts.yml linked to /home/sa/.cache/molecule/ansible-clickhouse/centos_7/inventory/hosts
INFO     Inventory /home/sa/ansible-clickhouse/molecule/centos_7/../resources/inventory/group_vars/ linked to /home/sa/.cache/molecule/ansible-clickhouse/centos_7/inventory/group_vars
INFO     Inventory /home/sa/ansible-clickhouse/molecule/centos_7/../resources/inventory/host_vars/ linked to /home/sa/.cache/molecule/ansible-clickhouse/centos_7/inventory/host_vars
INFO     Running centos_7 > dependency
WARNING  Skipping, missing the requirements file.
WARNING  Skipping, missing the requirements file.
INFO     Inventory /home/sa/ansible-clickhouse/molecule/centos_7/../resources/inventory/hosts.yml linked to /home/sa/.cache/molecule/ansible-clickhouse/centos_7/inventory/hosts
...
playbook: /home/sa/ansible-clickhouse/molecule/resources/playbooks/converge.yml
INFO     Inventory /home/sa/ansible-clickhouse/molecule/centos_7/../resources/inventory/hosts.yml linked to /home/sa/.cache/molecule/ansible-clickhouse/centos_7/inventory/hosts
INFO     Inventory /home/sa/ansible-clickhouse/molecule/centos_7/../resources/inventory/group_vars/ linked to /home/sa/.cache/molecule/ansible-clickhouse/centos_7/inventory/group_vars
INFO     Inventory /home/sa/ansible-clickhouse/molecule/centos_7/../resources/inventory/host_vars/ linked to /home/sa/.cache/molecule/ansible-clickhouse/centos_7/inventory/host_vars
INFO     Running centos_7 > create
...
TASK [Discover local Docker images] ********************************************
ok: [localhost] => (item={'diff': [], 'dest': '/home/sa/.cache/molecule/ansible-clickhouse/centos_7/Dockerfile_centos_7', 'src': '/home/sa/.ansible/tmp/ansible-tmp-1661954081.235305-32485-267253787192059/source', 'md5sum': 'e90d08cd34f49a5f8a41a07de1348618', 'checksum': '4b70768619482424811f2977aa277a5acf2b13a1', 'changed': True, 'uid': 1000, 'gid': 1000, 'owner': 'sa', 'group': 'sa', 'mode': '0600', 'state': 'file', 'size': 2199, 'invocation': {'module_args': {'src': '/home/sa/.ansible/tmp/ansible-tmp-1661954081.235305-32485-267253787192059/source', 'dest': '/home/sa/.cache/molecule/ansible-clickhouse/centos_7/Dockerfile_centos_7', 'mode': '0600', 'follow': False, '_original_basename': 'Dockerfile.j2', 'checksum': '4b70768619482424811f2977aa277a5acf2b13a1', 'backup': False, 'force': True, 'unsafe_writes': False, 'content': None, 'validate': None, 'directory_mode': None, 'remote_src': None, 'local_follow': None, 'owner': None, 'group': None, 'seuser': None, 'serole': None, 'selevel': None, 'setype': None, 'attributes': None}}, 'failed': False, 'item': {'capabilities': ['SYS_ADMIN'], 'command': '/usr/sbin/init', 'dockerfile': '../resources/Dockerfile.j2', 'env': {'ANSIBLE_USER': 'ansible', 'DEPLOY_GROUP': 'deployer', 'SUDO_GROUP': 'wheel', 'container': 'docker'}, 'image': 'centos:7', 'name': 'centos_7', 'privileged': True, 'tmpfs': ['/run', '/tmp'], 'volumes': ['/sys/fs/cgroup:/sys/fs/cgroup']}, 'ansible_loop_var': 'item', 'i': 0, 'ansible_index_var': 'i'})
...
TASK [Wait for instance(s) creation to complete] *******************************
FAILED - RETRYING: [localhost]: Wait for instance(s) creation to complete (300 retries left).
changed: [localhost] => (item={'failed': 0, 'started': 1, 'finished': 0, 'ansible_job_id': '128133508658.32615', 'results_file': '/home/sa/.ansible_async/128133508658.32615', 'changed': True, 'item': {'capabilities': ['SYS_ADMIN'], 'command': '/usr/sbin/init', 'dockerfile': '../resources/Dockerfile.j2', 'env': {'ANSIBLE_USER': 'ansible', 'DEPLOY_GROUP': 'deployer', 'SUDO_GROUP': 'wheel', 'container': 'docker'}, 'image': 'centos:7', 'name': 'centos_7', 'privileged': True, 'tmpfs': ['/run', '/tmp'], 'volumes': ['/sys/fs/cgroup:/sys/fs/cgroup']}, 'ansible_loop_var': 'item'})
...
TASK [ansible-clickhouse : include_tasks] **************************************
included: /home/sa/ansible-clickhouse/tasks/precheck.yml for centos_7
...
TASK [ansible-clickhouse : include_tasks] **************************************
included: /home/sa/ansible-clickhouse/tasks/params.yml for centos_7
...
TASK [ansible-clickhouse : include_tasks] **************************************
included: /home/sa/ansible-clickhouse/tasks/install/yum.yml for centos_7
...
TASK [ansible-clickhouse : include_tasks] **************************************
included: /home/sa/ansible-clickhouse/tasks/configure/sys.yml for centos_7
...
TASK [ansible-clickhouse : Config | Generate system config] ********************
--- before
+++ after: /home/sa/.ansible/tmp/ansible-local-327410lkn5fza/tmp355vng43/config.j2
@@ -0,0 +1,382 @@
+<?xml version="1.0"?>
+<!--
+ -
...
TASK [ansible-clickhouse : Config | Generate users config] *********************
--- before
+++ after: /home/sa/.ansible/tmp/ansible-local-327410lkn5fza/tmprm7rasbr/users.j2
@@ -0,0 +1,106 @@
+<?xml version="1.0"?>
+<!--
+ -
...
TASK [ansible-clickhouse : include_tasks] **************************************
included: /home/sa/ansible-clickhouse/tasks/service.yml for centos_7
...
TASK [ansible-clickhouse : include_tasks] **************************************
included: /home/sa/ansible-clickhouse/tasks/configure/db.yml for centos_7
...
TASK [ansible-clickhouse : include_tasks] **************************************
included: /home/sa/ansible-clickhouse/tasks/configure/dict.yml for centos_7

TASK [ansible-clickhouse : Config | Generate dictionary config] ****************
--- before
+++ after: /home/sa/.ansible/tmp/ansible-local-327410lkn5fza/tmp08paiyou/dicts.j2
@@ -0,0 +1,63 @@
+<?xml version="1.0"?>
+<!--
+ -
...
INFO     Pruning extra files from scenario ephemeral directory
sa@ubuntu22:~/ansible-clickhouse$
```
</details>
...
```console
sa@ubuntu22:~/vector-role$ molecule init scenario --driver-name docker
INFO     Initializing new scenario default...
INFO     Initialized scenario in /home/sa/vector-role/molecule/default successfully.
sa@ubuntu22:~/vector-role$
```
...
```console
sa@ubuntu22:~/vector-role$ molecule test
INFO     default scenario test matrix: dependency, lint, cleanup, destroy, syntax, create, prepare, converge, idempotence, side_effect, verify, cleanup, destroy
INFO     Performing prerun with role_name_check=0...
INFO     Set ANSIBLE_LIBRARY=/home/sa/.cache/ansible-compat/f5bcd7/modules:/home/sa/.ansible/plugins/modules:/usr/share/ansible/plugins/modules
INFO     Set ANSIBLE_COLLECTIONS_PATH=/home/sa/.cache/ansible-compat/f5bcd7/collections:/home/sa/.ansible/collections:/usr/share/ansible/collections
INFO     Set ANSIBLE_ROLES_PATH=/home/sa/.cache/ansible-compat/f5bcd7/roles:/home/sa/.ansible/roles:/usr/share/ansible/roles:/etc/ansible/roles
INFO     Using /home/sa/.cache/ansible-compat/f5bcd7/roles/artem_shtepa.vector_role symlink to current repository in order to enable Ansible to find the role using its expected full name.
...
playbook: /home/sa/vector-role/molecule/resources/converge.yml
...
TASK [Wait for instance(s) creation to complete] *******************************
changed: [localhost] => (item={'failed': 0, 'started': 1, 'finished': 0, 'ansible_job_id': '694370910668.38264', 'results_file': '/home/sa/.ansible_async/694370910668.38264', 'changed': True, 'item': {'image': 'docker.io/pycontribs/centos:7', 'name': 'centos7', 'pre_build_image': True}, 'ansible_loop_var': 'item'})
FAILED - RETRYING: [localhost]: Wait for instance(s) creation to complete (300 retries left).
changed: [localhost] => (item={'failed': 0, 'started': 1, 'finished': 0, 'ansible_job_id': '505681089154.38290', 'results_file': '/home/sa/.ansible_async/505681089154.38290', 'changed': True, 'item': {'image': 'docker.io/pycontribs/centos:8', 'name': 'centos8', 'pre_build_image': True}, 'ansible_loop_var': 'item'})
changed: [localhost] => (item={'failed': 0, 'started': 1, 'finished': 0, 'ansible_job_id': '681996805273.38323', 'results_file': '/home/sa/.ansible_async/681996805273.38323', 'changed': True, 'item': {'image': 'docker.io/pycontribs/ubuntu:latest', 'name': 'ubuntu', 'pre_build_image': True}, 'ansible_loop_var': 'item'})
...
--- before
+++ after: /home/sa/.ansible/tmp/ansible-local-38634vd4fbr1r/tmp2m12gnzi/vector.toml.j2
@@ -0,0 +1,24 @@
+# Set global options
...
changed: [centos7]
--- before
+++ after: /home/sa/.ansible/tmp/ansible-local-38634vd4fbr1r/tmpvgzhew_n/vector.toml.j2
@@ -0,0 +1,24 @@
+# Set global options
+data_dir = "/var/lib/vector"
+
...
changed: [ubuntu]
--- before
+++ after: /home/sa/.ansible/tmp/ansible-local-38634vd4fbr1r/tmpdsjgvgmu/vector.toml.j2
@@ -0,0 +1,24 @@
+# Set global options
+data_dir = "/var/lib/vector"
+
...
--- before
+++ after: /home/sa/.ansible/tmp/ansible-local-38634vd4fbr1r/tmp9t21ccx1/vector.service.j2
@@ -0,0 +1,16 @@
+[Unit]
+Description=Vector
...
changed: [centos7]
--- before
+++ after: /home/sa/.ansible/tmp/ansible-local-38634vd4fbr1r/tmpx5rqhlvm/vector.service.j2
@@ -0,0 +1,16 @@
+[Unit]
+Description=Vector
+Documentation=https://vector.dev
...
changed: [centos8]
--- before
+++ after: /home/sa/.ansible/tmp/ansible-local-38634vd4fbr1r/tmpyx13qio2/vector.service.j2
@@ -0,0 +1,16 @@
+[Unit]
+Description=Vector
+Documentation=https://vector.dev
...
После создания контернера, на нём применена роль [AlexeySetevoi/ansible-clickhouse](https://github.com/AlexeySetevoi/ansible-clickhouse).
...
```console
sa@ubuntu22:~/vector-role$ molecule --version
molecule 4.0.1 using python 3.10
    ansible:2.13.3
    delegated:4.0.1 from molecule
    docker:2.0.0 from molecule_docker requiring collections: community.docker>=3.0.0-a2
...
```console
sa@ubuntu22:~/vector-role$ docker run --privileged=True --rm -v ~/vector-role:/opt/vector-role -w /opt/vector-role -it aragast/netology:latest /bin/bash
...
```console
sa@ubuntu22:~/vector-role$ molecule init scenario podman --driver-name podman
INFO     Initializing new scenario podman...
INFO     Initialized scenario in /home/sa/vector-role/molecule/podman successfully.
sa@ubuntu22:~/vector-role$
```
...
К сожалению, прогон роли на разных окружениях в **Tox** также провалился, но по другой причине:
при выполнении драйвером **molecule_podman** команды `/usr/bin/podman run -d --name centos7 --hostname=centos7 docker.io/pycontribs/centos:7 bash -c "while true; do sleep 10000; done"`
**podman** не удалось создать контейнер по причине `Error: invalid config provided: cannot set hostname when running in the host UTS namespace: invalid configuration`, то есть неверно задана конфигурация контейнера (нельзя указывать `--hostname`).

> :exclamation: Решение данной проблемы в рамках домашнего задания видется весьма сложным, так как модифицировать исходный код модуля **molecule_podman** с целью удаления этого параметра в данном случе не достаточно - возникают другие ошибки

Если модифицировать `tox.ini` следующим образом:
...
```console
[root@cd2151c151a6 vector-role]# tox
py37-ansible210 installed: ansible==2.10.7,ansible-base==2.10.17,ansible-compat==1.0.0,ansible-lint==5.1.3,arrow==1.2.3,bcrypt==4.0.0,binaryornot==0.4.4,bracex==2.3.post1,cached-property==1.5.2,Cerberus==1.3.2,certifi==2022.6.15.1,cffi==1.15.1,chardet==5.0.0,charset-normalizer==2.1.1,click==8.1.3,click-help-colors==0.9.1,commonmark==0.9.1,cookiecutter==2.1.1,cryptography==38.0.1,distro==1.7.0,enrich==1.2.7,idna==3.3,importlib-metadata==4.12.0,Jinja2==3.1.2,jinja2-time==0.2.0,jmespath==1.0.1,lxml==4.9.1,MarkupSafe==2.1.1,molecule==3.4.0,molecule-podman==1.0.1,packaging==21.3,paramiko==2.11.0,pathspec==0.10.1,pluggy==0.13.1,pycparser==2.21,Pygments==2.13.0,PyNaCl==1.5.0,pyparsing==3.0.9,python-dateutil==2.8.2,python-slugify==6.1.2,PyYAML==5.4.1,requests==2.28.1,rich==12.5.1,ruamel.yaml==0.17.21,ruamel.yaml.clib==0.2.6,selinux==0.2.1,six==1.16.0,subprocess-tee==0.3.5,tenacity==8.0.1,text-unidecode==1.3,typing_extensions==4.3.0,urllib3==1.26.12,wcmatch==8.4,yamllint==1.26.3,zipp==3.8.1
...
Готовая роль [Lighthouse](https://github.com/ArtemShtepa/lighthouse-role)

Для создания сценария проверки всего стека **Clickhouse** + **Vector** + **Lighthouse**
лечше не засорять какую-то роль, а создать просто отдельный сценарий, например, следующей командой:
`molecule init scenario fullstack --driver-name=docker`.

Файлы готового [сценария](fullstack/) (описание прилагается)

Достаточный сценарий проверки всего стека включал бы всего два этапа - запись в файлы,
контролируемые **Vector**, и считывание результата в **Lighthouse**.
Однако, к сожалению, подобное реализовать затруднительно, так как **Lighthouse** не имеет
каких-либо API (что логично) и поэтому его работа будет дополнительно проверена в ручном режиме
до уничтожения контейнеров.

<details>
<summary>:exclamation: Технический прогон всего стека <b>molecule</b>... Лог очень длинный :bangbang:</summary>

```console
sa@ubuntu22:~/fullstack$ molecule test
INFO     default scenario test matrix: dependency, lint, syntax, destroy, create, converge, idempotence, cleanup, verify, destroy
INFO     Performing prerun with role_name_check=0...
INFO     Set ANSIBLE_LIBRARY=/home/sa/.cache/ansible-compat/47ebf3/modules:/home/sa/.ansible/plugins/modules:/usr/share/ansible/plugins/modules
INFO     Set ANSIBLE_COLLECTIONS_PATH=/home/sa/.cache/ansible-compat/47ebf3/collections:/home/sa/.ansible/collections:/usr/share/ansible/collections
INFO     Set ANSIBLE_ROLES_PATH=/home/sa/.cache/ansible-compat/47ebf3/roles:/home/sa/.ansible/roles:/usr/share/ansible/roles:/etc/ansible/roles
INFO     Running default > dependency
Cloning into '/home/sa/.ansible/tmp/ansible-local-219894e2s8c45a/tmpbji306br/ansible-collectionxw2ha1et'...
Your branch is up to date with 'origin/main'.
[WARNING]: The requirements file
'/home/sa/fullstack/molecule/default/requirements.yml' contains collections
which will be ignored. To install these collections run 'ansible-galaxy
...
- extracting clickhouse-role to /home/sa/.cache/molecule/fullstack/default/roles/clickhouse-role
- clickhouse-role (1.13) was installed successfully
- extracting vector-role to /home/sa/.cache/molecule/fullstack/default/roles/vector-role
- vector-role (1.0.5) was installed successfully
- extracting lighthouse-role to /home/sa/.cache/molecule/fullstack/default/roles/lighthouse-role
- lighthouse-role (1.0.4) was installed successfully
...
playbook: /home/sa/fullstack/molecule/default/converge.yml
INFO     Running default > destroy
...
TASK [Check presence of custom Dockerfiles] ************************************
ok: [localhost] => (item={'hostname': 'clickhouse', 'image': 'docker.io/pycontribs/centos:7', 'name': 'clickhouse', 'pre_build_image': True, 'published_ports': ['0.0.0.0:9000:9000/tcp', '[::]:9000:9000/tcp', '0.0.0.0:8123:8123/tcp', '[::]:8123:8123/tcp']})
ok: [localhost] => (item={'hostname': 'vector', 'image': 'docker.io/pycontribs/centos:7', 'name': 'vector', 'pre_build_image': True})
ok: [localhost] => (item={'hostname': 'lighthouse', 'image': 'docker.io/pycontribs/centos:7', 'name': 'lighthouse', 'pre_build_image': True, 'published_ports': ['0.0.0.0:8080:8080/tcp', '[::]:8080:8080/tcp']})

TASK [Create Dockerfiles from image names] *************************************
skipping: [localhost] => (item={'hostname': 'clickhouse', 'image': 'docker.io/pycontribs/centos:7', 'name': 'clickhouse', 'pre_build_image': True, 'published_ports': ['0.0.0.0:9000:9000/tcp', '[::]:9000:9000/tcp', '0.0.0.0:8123:8123/tcp', '[::]:8123:8123/tcp']})
skipping: [localhost] => (item={'hostname': 'vector', 'image': 'docker.io/pycontribs/centos:7', 'name': 'vector', 'pre_build_image': True})
skipping: [localhost] => (item={'hostname': 'lighthouse', 'image': 'docker.io/pycontribs/centos:7', 'name': 'lighthouse', 'pre_build_image': True, 'published_ports': ['0.0.0.0:8080:8080/tcp', '[::]:8080:8080/tcp']})

TASK [Discover local Docker images] ********************************************
ok: [localhost] => (item={'changed': False, 'skipped': True, 'skip_reason': 'Conditional result was False', 'item': {'hostname': 'clickhouse', 'image': 'docker.io/pycontribs/centos:7', 'name': 'clickhouse', 'pre_build_image': True, 'published_ports': ['0.0.0.0:9000:9000/tcp', '[::]:9000:9000/tcp', '0.0.0.0:8123:8123/tcp', '[::]:8123:8123/tcp']}, 'ansible_loop_var': 'item', 'i': 0, 'ansible_index_var': 'i'})
ok: [localhost] => (item={'changed': False, 'skipped': True, 'skip_reason': 'Conditional result was False', 'item': {'hostname': 'vector', 'image': 'docker.io/pycontribs/centos:7', 'name': 'vector', 'pre_build_image': True}, 'ansible_loop_var': 'item', 'i': 1, 'ansible_index_var': 'i'})
ok: [localhost] => (item={'changed': False, 'skipped': True, 'skip_reason': 'Conditional result was False', 'item': {'hostname': 'lighthouse', 'image': 'docker.io/pycontribs/centos:7', 'name': 'lighthouse', 'pre_build_image': True, 'published_ports': ['0.0.0.0:8080:8080/tcp', '[::]:8080:8080/tcp']}, 'ansible_loop_var': 'item', 'i': 2, 'ansible_index_var': 'i'})
...
TASK [Wait for instance(s) creation to complete] *******************************
FAILED - RETRYING: [localhost]: Wait for instance(s) creation to complete (300 retries left).
changed: [localhost] => (item={'failed': 0, 'started': 1, 'finished': 0, 'ansible_job_id': '543162184725.220342', 'results_file': '/home/sa/.ansible_async/543162184725.220342', 'changed': True, 'item': {'hostname': 'clickhouse', 'image': 'docker.io/pycontribs/centos:7', 'name': 'clickhouse', 'pre_build_image': True, 'published_ports': ['0.0.0.0:9000:9000/tcp', '[::]:9000:9000/tcp', '0.0.0.0:8123:8123/tcp', '[::]:8123:8123/tcp']}, 'ansible_loop_var': 'item'})
changed: [localhost] => (item={'failed': 0, 'started': 1, 'finished': 0, 'ansible_job_id': '592402742640.220368', 'results_file': '/home/sa/.ansible_async/592402742640.220368', 'changed': True, 'item': {'hostname': 'vector', 'image': 'docker.io/pycontribs/centos:7', 'name': 'vector', 'pre_build_image': True}, 'ansible_loop_var': 'item'})
changed: [localhost] => (item={'failed': 0, 'started': 1, 'finished': 0, 'ansible_job_id': '807603297502.220400', 'results_file': '/home/sa/.ansible_async/807603297502.220400', 'changed': True, 'item': {'hostname': 'lighthouse', 'image': 'docker.io/pycontribs/centos:7', 'name': 'lighthouse', 'pre_build_image': True, 'published_ports': ['0.0.0.0:8080:8080/tcp', '[::]:8080:8080/tcp']}, 'ansible_loop_var': 'item'})
...
TASK [Create systemd directories] **********************************************
changed: [vector] => (item=/run/systemd/system)
changed: [clickhouse] => (item=/run/systemd/system)
changed: [lighthouse] => (item=/run/systemd/system)
ok: [clickhouse] => (item=/usr/lib/systemd/system)
ok: [vector] => (item=/usr/lib/systemd/system)
ok: [lighthouse] => (item=/usr/lib/systemd/system)
...
included: /home/sa/.cache/molecule/fullstack/default/roles/clickhouse-role/tasks/precheck.yml for clickhouse
...
TASK [clickhouse-role : include_tasks] *****************************************
included: /home/sa/.cache/molecule/fullstack/default/roles/clickhouse-role/tasks/params.yml for clickhouse
...
TASK [clickhouse-role : include_tasks] *****************************************
included: /home/sa/.cache/molecule/fullstack/default/roles/clickhouse-role/tasks/install/yum.yml for clickhouse
...
TASK [clickhouse-role : Install by YUM | Ensure clickhouse package installed (version 22.3.3.44)] ***
changed: [clickhouse]

TASK [clickhouse-role : include_tasks] *****************************************
included: /home/sa/.cache/molecule/fullstack/default/roles/clickhouse-role/tasks/configure/sys.yml for clickhouse
...
TASK [clickhouse-role : include_tasks] *****************************************
included: /home/sa/.cache/molecule/fullstack/default/roles/clickhouse-role/tasks/service.yml for clickhouse
...
TASK [clickhouse-role : include_tasks] *****************************************
included: /home/sa/.cache/molecule/fullstack/default/roles/clickhouse-role/tasks/configure/db.yml for clickhouse
...
TASK [clickhouse-role : include_tasks] *****************************************
included: /home/sa/.cache/molecule/fullstack/default/roles/clickhouse-role/tasks/configure/dict.yml for clickhouse
...
TASK [vector-role : Create vector directories] *********************************
changed: [vector] => (item=/var/lib/vector)
changed: [vector] => (item=/etc/vector)
...
TASK [lighthouse-role : Check Lighthouse port] *********************************
ok: [lighthouse] => {
    "changed": false,
    "msg": "All assertions passed"
}
...
TASK [lighthouse-role : Get files of repo] *************************************
skipping: [lighthouse]

TASK [lighthouse-role : Comment current url] ***********************************
skipping: [lighthouse]

TASK [lighthouse-role : Uncomment vault url] ***********************************
skipping: [lighthouse]

TASK [lighthouse-role : Update APT package manager cache] **********************
skipping: [lighthouse]

TASK [lighthouse-role : Install NGinX and Git] *********************************
changed: [lighthouse] => (item=nginx)
ok: [lighthouse] => (item=git)

TASK [lighthouse-role : Check lighthouse files] ********************************
fatal: [lighthouse]: FAILED! => {"changed": false, "msg": "file (/usr/share/nginx/lighthouse/app.js) is absent, cannot continue", "path": "/usr/share/nginx/lighthouse/app.js", "state": "absent"}
...ignoring
...
TASK [lighthouse-role : Add new server by custom port] *************************
changed: [lighthouse]
...
PLAY RECAP *********************************************************************
clickhouse                 : ok=31   changed=13   unreachable=0    failed=0    skipped=11   rescued=0    ignored=0
lighthouse                 : ok=18   changed=9    unreachable=0    failed=0    skipped=6    rescued=0    ignored=1
vector                     : ok=19   changed=13   unreachable=0    failed=0    skipped=2    rescued=0    ignored=0
...
TASK [Create systemd directories] **********************************************
ok: [vector] => (item=/run/systemd/system)
ok: [clickhouse] => (item=/run/systemd/system)
ok: [lighthouse] => (item=/run/systemd/system)
ok: [vector] => (item=/usr/lib/systemd/system)
ok: [lighthouse] => (item=/usr/lib/systemd/system)
ok: [clickhouse] => (item=/usr/lib/systemd/system)
...
TASK [clickhouse-role : Ensure clickhouse-server.service is enabled: True and state: started] ***
ok: [clickhouse]
...
TASK [vector-role : Create vector directories] *********************************
ok: [vector] => (item=/var/lib/vector)
ok: [vector] => (item=/etc/vector)
...
PLAY RECAP *********************************************************************
clickhouse                 : ok=29   changed=0    unreachable=0    failed=0    skipped=12   rescued=0    ignored=0
lighthouse                 : ok=16   changed=0    unreachable=0    failed=0    skipped=7    rescued=0    ignored=0
vector                     : ok=18   changed=0    unreachable=0    failed=0    skipped=2    rescued=0    ignored=0

INFO     Idempotence completed successfully.
INFO     Running default > cleanup

PLAY [Clean up Clickhouse] *****************************************************

TASK [Truncate tables] *********************************************************
ok: [clickhouse]

PLAY [Clean up Vector] *********************************************************

TASK [Delete log files] ********************************************************
ok: [vector] => (item=~/test/one.log)
ok: [vector] => (item=~/test/two.log)

PLAY RECAP *********************************************************************
clickhouse                 : ok=1    changed=0    unreachable=0    failed=0    skipped=0    rescued=0    ignored=0
vector                     : ok=1    changed=0    unreachable=0    failed=0    skipped=0    rescued=0    ignored=0
...
PLAY [Verify lighthouse installation] ******************************************

TASK [Get information about nginx] *********************************************
ok: [lighthouse]

TASK [Assert nginx service] ****************************************************
ok: [lighthouse] => {
    "changed": false,
    "msg": "All assertions passed"
}

TASK [Save server home page] ***************************************************
changed: [lighthouse]

TASK [Get home page] ***********************************************************
ok: [lighthouse]

TASK [Assert lighthouse homepage] **********************************************
ok: [lighthouse] => {
    "changed": false,
    "msg": "All assertions passed"
}

PLAY [Store data to vector] ****************************************************

TASK [Create files] ************************************************************
changed: [vector] => (item=~/test/one.log)
changed: [vector] => (item=~/test/two.log)

TASK [Write some data to file] *************************************************
changed: [vector] => (item=First line)
changed: [vector] => (item=Second line)
changed: [vector] => (item=Third line)

TASK [Write some data to another file] *****************************************
changed: [vector] => (item=A little bit of data)
changed: [vector] => (item=Some amount of data)
changed: [vector] => (item=More data)

PLAY [Check Clickhouse data] ***************************************************

TASK [include_tasks] ***********************************************************
included: /home/sa/fullstack/molecule/default/verify_clickhouse.yml for clickhouse

TASK [Decrease attempts count] *************************************************
ok: [clickhouse]

TASK [Get clickhouse response] *************************************************
ok: [clickhouse]

TASK [Compose acquired data to list] *******************************************
ok: [clickhouse]

TASK [Print acquired data] *****************************************************
ok: [clickhouse] => {
    "data_raw": [
...
TASK [Verify acquired data] ****************************************************
fatal: [clickhouse]: FAILED! => {
    "assertion": "data_raw | length == 6",
    "changed": false,
    "evaluated_to": false,
    "msg": "Assertion failed"
}

TASK [Fail if retry count is zero] *********************************************
skipping: [clickhouse]

TASK [Try another attempt after delay] *****************************************
ok: [clickhouse -> localhost]
...
PLAY RECAP *********************************************************************
clickhouse                 : ok=12   changed=0    unreachable=0    failed=0    skipped=1    rescued=1    ignored=0
lighthouse                 : ok=5    changed=1    unreachable=0    failed=0    skipped=0    rescued=0    ignored=0
vector                     : ok=7    changed=3    unreachable=0    failed=0    skipped=0    rescued=0    ignored=0
...
INFO     Pruning extra files from scenario ephemeral directory
sa@ubuntu22:~/fullstack$
```
</details>

Ручная проверка **Lighthouse** перед уничтожением окружения (`molecule test --destroy=never`)
...
[Параметры конфигурационного файла](https://docs.ansible.com/ansible/latest/reference_appendices/config.html)

### Molecule

Используемые команды:

  - `molecule matrix test -s docker` - вывод шагов, которые будут выполнены при запуске тестирования сценария docker
  - `molecule create` - запуск только шага **create**
  - `molecule matrix create` - вывод выполняемых действий для шага **create**
  - `molecule test --destroy=never` - запуск тестирования, при этом шаг **destroy** не должен запускать
  - `init role --driver-name docker` - инициализация дерева каталогов и файлов для функционирования **molecule** с драйвером **docker**
  - `molecule <taskname>` - исполнение определённой **task**

Главы **molecule.yml**:

  - **dependency** - перечиление зависимостей роли
  - **driver** - параметры выбранного драйвера
  - **platform** - перечисление хостов для выбранного драйвера
  - **provisioner** - указание поставщика molecule - доступен только ansilbe
  ...
  - **lint** - конфигурирование linter для тестирования
    ```yaml
      lint: |
        ...
        ansible-lint .
    ```
  - **scenario** - перечилсение сценариев тестирования
    ```yaml
      scenario:
        test_scenario:
          - dependency
...
Вместо **destroy** можно использовать **cleanup** - предназначен для чистки машин от **molecule**

**side_effect** - **playbook** создания **side effects** на инфраструктуре, чтобы тестировать определённые сценарии (воспроизведение ошибки)

**clenaup** - **playbook** чистки машин от внесённых изменений, которые приведут её к изначальному состоянию (отмена изменений)

### Tox

  - `tox -l` - вывод всех возможных окружений **tox**

  - `tox -r` - принудительное создание окружений **tox**

  - `tox -e <env_names>` - запуск **tox** на указанных окружениях
