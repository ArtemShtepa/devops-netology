...
- **Kubernetes** также будем **использовать** - для управления контейнерами (оркестрации) **Docker**
...
Итоговый минимальный стек используемых инструментов: **TeamCity** (если в нём нет системы контроля версий, то дополнительно нужно использовать **Git**, либо заменить на **GitLab**), **Terraform**, **Ansible**, **Docker**, **Kubernetes** (в принципе, может быть заменён на **Docker Swarm**)
